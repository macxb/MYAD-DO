...
exports.run = async (client, message) => {
  const embed = new Discord.RichEmbed()
    ...
    .setColor(0x00AF46)
    .setDescription("**Aegis Veteran**")
    .setFooter("MYAD TECHNOLOGIES S.L.E.","https://cdn.discordapp.com/emojis/401818289023483904.png?v=1%22")
    .setThumbnail("https://cdn.discordapp.com/attachments/507454734139916288/514150043184267266/a-veteran-mmo_100x100.png")
    .setTimestamp()
    .setURL("http://myriad.bitcoinbetmaster.com/")
    .addField("**Descripcion en el Juego:**","La Aegis es una de las tres naves, con habilidades y estadisticas que la hacen una nave de apoyo perfecta o una buena nave PvP. Este diseño es mejor que la Aegis normal", true)
    ...
    .addField("**Bonificaciones:**","Expe ``5%``\nHonor ``5%``", true);

...
//CONSOLE-----------------------------------------------------------------------
client.on("ready", () => {
  let msg = client.channels.get("517340362164142090").messages.size.toString();
  ...
  //client.user.setActivity("/ayuda", {type: "WATCHING"});

});

const activities_list = [
    "",
    "ayudar a pekes en 1-4", 
    "proteger la flota en 5-3",
    "vender pala en 5-2", 
    "sacar Prometheus 😏 ",
    "petar potes de bases enemigas.",
    "petar 🐀petapekes pq si, pq mola, pq es la moda..." 
